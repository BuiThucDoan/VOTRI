...
$_SESSION['ngayXacNhan'] = $ngaylenmon;
...
<main id="main" class="main">
  ...
  <div class="">
    ...
    <h1>Xác nhận phiếu đặt món</h1>

    <nav>
      <ol class="breadcrumb">

        <li class="breadcrumb-item"><?php echo $_SESSION['ngayXacNhan']   ?></li>
          ...
          <div class="card-body">
            <div style="display: flex;">
              ...
              <form style="margin: 15px 20px" action="" method="post">
                <input type="date" name="date" id="date" value="<?php echo $_SESSION['ngayXacNhan'] ?>">
            ...
            <table id="example" class="table table-striped">
              ...
              <input type="hidden" name="date" value="<?php echo $_SESSION['ngayXacNhan']  ?>">
              <input type="submit" value="Xác nhận" name="btn_duyet">
...
if (isset($_POST['btn_duyet'])) {
  ...
  $ngaylenmon = $_SESSION['ngayXacNhan'];
$p-> XacNhanPhieu($trangthai, $ngaylenmon);

echo header("refresh: 0; url='admin.php?mod=XacNhanPhieu&date=$ngaylenmon'");
}
